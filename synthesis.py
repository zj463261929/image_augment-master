...
image_dir = "/opt/zhangjing/ocr/augmented_dataset/image_augment-master/result_detect/" #要合并的文件夹，将文件夹下面所有文件合并,   改
save_dir = "/opt/zhangjing/ocr/augmented_dataset/image_augment-master/all/"                 #合并后保存的位置,  改
isRecognition = False   #True表拷贝的样本是识别，False为检测,  改

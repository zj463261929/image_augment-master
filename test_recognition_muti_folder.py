...
image_dir_list = ["/opt/yushan/data/emotion/disgust_gray/",
                "/opt/yushan/data/emotion/anger_gray/",
                "/opt/yushan/data/emotion/happy_gray/",
                "/opt/yushan/data/emotion/sad_gray/",
                "/opt/yushan/data/emotion/surprise_gray/"]
image_txt_lst = ["/opt/yushan/data/emotion/img_disgust_gray.txt",
                "/opt/yushan/data/emotion/img_anger_gray.txt",
                "/opt/yushan/data/emotion/img_happy_gray.txt",
                "/opt/yushan/data/emotion/img_sad_gray.txt",
                "/opt/yushan/data/emotion/img_surprise_gray.txt"]
                
save_dir_lst = ["/opt/yushan/data/emotion/disgust_gray_augument/",
                "/opt/yushan/data/emotion/anger_gray_augument/",
                "/opt/yushan/data/emotion/happy_gray_augument/",
                "/opt/yushan/data/emotion/sad_gray_augument/",
                "/opt/yushan/data/emotion/surprise_gray_augument/"]
        ...
        for l in lines:
            ...
            if len(lst)>0:
                ...
                if 1: #噪音
                    ...
                    result = fun.noise(img, param=0.1, type=0) #type:（0=高斯,1=椒盐噪声）
                    if result is None:
                        continue
                ...
                if 1: #镜像
                    result = fun.flip(img, flipCode=1) #flipCode:（0=沿x轴翻转(上下),1=沿y轴翻转(左右),2=180旋转）
                    if result is None:
                        continue
                ...
                if 1: #镜像后调整对比度、亮度
                    mean = getImgMean(result)
                    alpha = (2.0-0.0)*(1-mean/255)
                    beta = random.randint(-10, 10)
                    
                    result1 = fun.contrastAndBright(result, alpha, beta)
                    if result1 is None:
                        continue
